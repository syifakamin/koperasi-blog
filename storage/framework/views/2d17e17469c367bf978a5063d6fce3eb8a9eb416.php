        ...
        <div class="row mt-5">
            <div class="offset-md-3 col-lg-6">
                ...
                <div class="login_form_inner">
                    <h3>Masuk</h3>
                    <form class="row login_form" action="<?php echo e(url('member/login')); ?>" method="post" id="contactForm" novalidate="novalidate">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <a href="<?php echo e(route('customer.register')); ?>" class="pb-5">Tidak punya akun ? Silahkan daftar di sini.</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\Koperasi-Blog\resources\views/ecommerce/login.blade.php ENDPATH**/ ?>